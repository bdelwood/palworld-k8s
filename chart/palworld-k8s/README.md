...
![Version: 0.12.0](https://img.shields.io/badge/Version-0.12.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.3.2](https://img.shields.io/badge/AppVersion-v2.3.2-informational?style=flat-square)
...
| probes.liveness | object | `{}` | Liveness probe. `pgrep -f` avoids the 15-char comm-name truncation. |
| probes.readiness | object | `{}` | Readiness probe. Requires RCON_ENABLED=true; `-a` is required in exec context. |
